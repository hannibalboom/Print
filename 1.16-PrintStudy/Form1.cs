...
namespace _1._16_PrintStudy
{
    public partial class Form1 : Form
    {
        ...
        private void btn_Print_Click(object sender, EventArgs e)
        {
            ...
            PrintFrm frm = new PrintFrm(uploadedImages);
            if (Printer == null || Printer.IsDisposed)//为空或已被释放
            {
                Printer = new PrintFrm(uploadedImages);//实例化
            ...
            string patientId = "20231114117100";
            string patientR_eye = "";
            string patientL_eye = "";
            frm.uploadedImages = uploadedImages;
            frm.selectedImagePaths = selectedImagePaths;
            //传递个人信息
            frm.patientName = patientName;
            frm.patientSex = patientSex;
            frm.patientAge = patientAge;
            frm.patientId = patientId;
            frm.patientR_eye = patientR_eye;
            frm.patientL_eye = patientL_eye;
            frm.Show();
        }
